...
(49, 12, 'сложно находить нужную информацию', 0),
(50, 12, 'сложный процесс оформления покупки', 0),
(51, 12, 'не нравится дизайн', 0),
(52, 12, 'нет возможности отследить покупку', 0),
(53, 12, 'некачественные фотографии товаров', 0),
(54, 12, 'мало описания товара', 0),
(55, 12, 'неудобство отображения функции сравнения', 0),
(56, 12, 'недостоверная информация о товаре', 0),
(57, 12, 'несоответствие товара его описанию', 0),
(58, 13, 'долго ждал оформления и выдачи товара', 0),
(59, 13, 'перепутали заказ', 0),
(60, 13, 'отказались дать дополнительную консультацию по товару', 0),
(61, 13, 'предложили отказаться от интернет-покупки и выкупить товар в розничном магазине', 0);
...
INSERT INTO `i_questions` (`id`, `content`, `category`) VALUES
(1, 'Добрый день, Client?', 0),
(3, 'Вас приветствует компания «Спектр Техники». Меня зовут User. \nМы проводим опрос о качестве обслуживания в магазинах нашей сети. Скажите, пожалуйста, у Вас есть возможность ответить на несколько вопросов? Это займет не более 2 минут.', 0),
(4, 'Скажите, пожалуйста, Вы посещали наш магазин на предыдущей (этой) неделе?', 0),
(5, 'Подскажите, компания «Спектр Техники» соответствует Вашим ожиданиям?', 0),
(6, 'Готовы ли Вы рекомендовать магазины «Спектр Техники» своим друзьям и знакомым?', 0),
(8, 'Если в будущем у Вас возникнет необходимость в приобретении новой техники, какова вероятность того, что Вы обратитесь именно в магазины «Спектр Техники»?', 0),
(9, 'Как бы Вы оценили  качество полученной консультации у сотрудников, которые Вас обслуживали?', 0),
(10, 'Подскажите, Вас устраивает товарный ассортимент в магазинах «Спектр Техники»?', 0),
(11, 'Подскажите, пожалуйста, нет ли у Вас замечаний к службе доставки?', 1),
(14, 'Добрый день, Client?', 2),
(15, 'Вас приветствует компания «Спектр Техники». Меня зовут User. \r\nМы проводим опрос о качестве обслуживания в магазинах нашей сети. Скажите, пожалуйста, у Вас есть возможность ответить на несколько вопросов? Это займет не более 1 минуты.', 2),
(16, 'Подскажите, удобен ли Вам Интернет-магазин «Спектр Техники»?', 2),
(17, 'Довольны ли Вы работой сотрудников при получении Интернет-заказа в пункте выдачи? ', 2);
